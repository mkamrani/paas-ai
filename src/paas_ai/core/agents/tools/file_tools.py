...
logger = get_logger("paas_ai.agents.file_tools")
...
class WriteFileInput(BaseModel):
    ...
    directory: str = Field(default=".", description="Directory to write the file in (default: current directory)")


class ReadFileInput(BaseModel):
    """Input schema for file reading tool."""
    filename: str = Field(description="The name/path of the file to read")
    directory: str = Field(default=".", description="Directory to read the file from (default: current directory)")
